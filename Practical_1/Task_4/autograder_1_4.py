...
def run_tests():
    try:
        student_code = importlib.import_module("student_code_1_4")
        func = student_code.calculate_gross_salary
    except Exception as e:
        return {"score": 0, "total": 0, "feedback": f"Error importing student code: {e}"}

    tests = [
        ("Basic Salary 1000", (1000,), 1000 + 700 + 300 + 100),  # 2100
        ("Basic Salary 5000", (5000,), 5000 + 3500 + 1500 + 500),  # 10500
        ("Basic Salary 8000", (8000,), 8000 + 5600 + 2400 + 800),  # 16800
    ]
...
if __name__ == "__main__":
    ...
    if result['score'] == result['total']:
        unique_id = generate_unique_id("Assignment_1_4")
        print("\nToken: ", unique_id)