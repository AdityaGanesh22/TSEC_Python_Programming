...
def run_tests():
    try:
        ...
        buggy_program = student_code.buggy_program
    ...
    # Instead, it verifies that buggy_program exists for demonstration.
    try:
        buggy_program
        feedback.append("✅ buggy_program exists for debugging demonstration")
        score += 10
    except Exception as e:
        feedback.append(f"❌ buggy_program not found: {e}")
